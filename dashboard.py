...
def coverage_panel(store):
    ...
    return (
        ...
        'Bank, ADB, AfDB and EBRD debarment lists and FinCEN Section 311 '
...
def sdn_panel(today):
    ...
    return (
        ...
        'and EU consolidated lists, the World Bank, Asian Development Bank, '
        'African Development Bank and EBRD debarment lists (with MDB '
